...
namespace EnhancedUI.EnhancedScroller
{
    ...
    public partial class EnhancedScroller : MonoBehaviour, IBeginDragHandler, IEndDragHandler
    {
        #region Public
        ...
        /// </summary>
        private ScrollRect _scrollRectCache;
        private ScrollRect _scrollRect => _scrollRectCache ??= this.GetComponent<ScrollRect>();

        /// <summary>
        /// Cached reference to the scrollRect's transform
        /// </summary>
        private RectTransform _scrollRectTransformCache;
        private RectTransform _scrollRectTransform => _scrollRectTransformCache ??= _scrollRect.GetComponent<RectTransform>();
